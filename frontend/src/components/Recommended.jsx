...
//       axios.post(`http://localhost:8001/recommend/0025bfe6248070545d23721083acd3f60451da4f`, { top_n: 10 }) // Update with your actual URL
//         .then(response => {
...
const Recommended = () => {
  ...
  //   const userId = sessionStorage.getItem('userID');
  //   if (userId) {
  //     axios.post(`http://localhost:8001/recommend/0025bfe6248070545d23721083acd3f60451da4f`, { top_n: 10 }) // Use actual userId
  //       .then(response => {
  //         setRecommendedSongs(response.data.recommended_tracks);
  //       })
  //       .catch(error => {
  ...
  // useEffect(() => {
  //   const userId = sessionStorage.getItem('userID');
  //   const isNewUser = sessionStorage.getItem('isNewUser') === 'true'; // Check if the user is new
  
  //   if (userId) {
  //     if (isNewUser) {
  //       // If the user is new, fetch the saved track info from the preferences page
  //       // Assuming you have a way to get saved track info from session storage
  //       const savedTracks = JSON.parse(sessionStorage.getItem('savedTracks')) || [];
  //       if (savedTracks.length > 0) {
  //         setRecommendedSongs(savedTracks);
  //       } else {
  //         // If no saved tracks, you might want to fetch the regular recommendations as a fallback
  //         axios.post(`http://localhost:8001/recommend/0025bfe6248070545d23721083acd3f60451da4f`, { top_n: 10 })
  //           .then(response => {
  //             setRecommendedSongs(response.data.recommended_tracks);
  //           })
  //           .catch(error => {
  ...
  //       }
  //     } else {
  //       // Regular recommendation fetching for existing users
  //       axios.post(`http://localhost:8001/recommend/0025bfe6248070545d23721083acd3f60451da4f`, { top_n: 10 })
  //         .then(response => {
  //           setRecommendedSongs(response.data.recommended_tracks);
  //         })
